...
global backend, inp,layers, models, keras_utils
...
def Unet(
    ...
    assert backbone_name != "inceptionresnetv2", "Not supported currently"
    assert backbone_name != "inceptionv3", "Not supported currently"
